...
class ReRaLSTM:
    def __init__(self, data_path, market_name, tickers_fname, relation_name,
        ...
        self.emb_tickers = np.genfromtxt(os.path.join(self.data_path, '..', self.market_name + '_tickers_qualify_dr-0.98_min-5_smooth.csv'), dtype=str, delimiter='\t', skip_header=False)
        new_emb = []
...
if __name__ == '__main__':
    ...
    parser.add_argument('-p', help='path of EOD data',
                        default=os.path.join("..", "data", "test_features"))
